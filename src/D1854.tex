...
\begin{document}
    ...
    \begin{addedblock}
        ...
        If a multicharacter literal contains a \grammarterm{basic-c-char} that is not encodable as a single code unit in the ordinary literal encoding, the program is ill-formed.
    \end{addedblock}
