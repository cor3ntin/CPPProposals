...
\begin{document}
    ...
    \begin{itemize}
        ...
        \item It makes multi-characters literals slightly less confusing as it is difficult to imagine how multiple codepoints over 0x80 could be stuffed into an \tcode{int} in any sensible way.
    \end{itemize}
    ...
    \begin{addedblock}
        ...
        If a multicharacter literal contains a \grammarterm{basic-c-char} representing a codepoint that is not encodable as a single code unit in the ordinary literal encoding, the program is ill-formed.
    \end{addedblock}
