...
class tuple {
    ...
    @\added{template<\placeholder{tuple-like} UTuple>}@
    @\added{constexpr explicit(\seebelow) tuple(const tuple<UTypes...>\&);}@
    @\added{template<\placeholder{tuple-like} UTuple>}@
    @\added{constexpr explicit(\seebelow) tuple(tuple<UTypes...>\&\&);}@
    ...
    @\added{template<\placeholder{tuple-like} UTuple>}@
    @\added{constexpr explicit(\seebelow) tuple(allocator_arg_t, const Alloc\& a, const tuple<UTypes...>\&);}@
    @\added{template<\placeholder{tuple-like} UTuple>}@
    @\added{constexpr explicit(\seebelow) tuple(allocator_arg_t, const Alloc\& a, tuple<UTypes...>\&\&);}@
    ...
    @\added{template<\placeholder{tuple-like} UTuple>}@
    @\added{constexpr tuple\& operator=(const UTuple\&);}@
    @\added{template<\placeholder{tuple-like} UTuple>}@
    @\added{constexpr tuple\& operator=(UTuple\&\&)};@
...
@\added{template<\placeholder{tuple-like} UTuple>}@
@\added{constexpr explicit(\seebelow) tuple(const UTuple\& u);}@
\end{itemdecl}
