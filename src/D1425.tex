...
namespace std {
	...
	@\added{-> queue<typename iterator_traits<InputIterator>::value_type>;}@
        ...
        @\added{queue(InputIterator, InputIterator, Allocator)}@
        @\added{-> queue<typename iterator_traits<InputIterator>::value_type>;}@
\end{codeblock}  


\textbf{Note for LWG: Align the deduction guide with the outcome of \paper{P1518R0}} ?
...
namespace std {
	...
	@\added{-> stack<typename iterator\_traits<InputIterator>::value_type>;}@
