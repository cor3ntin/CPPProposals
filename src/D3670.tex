...
\item if neither of their \grammarterm{constant-expression}{s} is value-dependent, then they have the same value, otherwise their constant-expressions are equivalent ([temp.over.link]).
\end{itemize}
