...
\tcode{name} is treated as a NTBS in the literal encoding.
...
If \tcode{size == 0} is \tcode{true} the thread attribute should be ignored.
...
\begin{addedblock}
The parameters \tcode{attrs...} may affect the behavior of the new thread. (see [thread.attributes]).
\end{addedblock}
...
\begin{addedblock}
The parameters \tcode{attrs...} may affect the behavior of the new thread.
\end{addedblock}
