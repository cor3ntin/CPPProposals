...
\authorsix{Gašper Ažman}{gasper.azman@gmail.com}

\usepackage{color, colortbl}
\begin{document}
\maketitle
\paperquote{Incremental changes can substentially improve expressiveness - Sean Baxter}
...
Pack indexing is covered in more detail in \paper{P1858R2} and \cite{P2662R0} . \paper{P1858R2} Demonstrate how pack indexing can be used to simplify
