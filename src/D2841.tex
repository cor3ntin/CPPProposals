...
\tcode{with_values_t} takes a function and a predicate, and call the function with all the argument satisfying this predicate.
...
One of the basic motivations for this extension is the \tcode{decays_to<Concept>} concept adaptor.
...
Note that \tcode{C} is a template-parameter of \tcode{decays_to}, and must therefore participate in subsumption to make the above work.
...
we get into an interesting situation where the choice of template arguments of \tcode{S} can change the subsumption order.
...
on one hand \tcode{decay_to} and all other metaconcepts,
...
(and any \changed{template}{\grammarterm{type-tt-parameter}
} template arguments).
...
an alias template or \changed{a template \grammarterm{template-parameter}}{a \grammarterm{type-tt-parameter} template-parameter}.
\begin{note}
...
\begin{itemize}
\item the name of a class template or an alias template for a \grammarterm{type-tt-parameter},
\item the name of a variable template for a \grammarterm{variable-tt-parameter}, and
\item the name of a concept for a \grammarterm{concept-tt-parameter}.
\end{itemize}
\end{addedblock}
...
\item they are both \grammarterm{type-tt-parameter},
\item they are both \grammarterm{variable-tt-parameter}, or
...
\begin{itemize}
\item \placeholder{A} denotes the name of a class template or alias template and \placeholder{P} is a \grammarterm{type-tt-parameter},
\item \placeholder{A} denotes the name of a variable template and \placeholder{P} is a \grammarterm{variable-tt-parameter}, or
