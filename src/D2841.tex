...
A \defn{type template parameter} is a template parameter introduced by a \grammarterm{type-parameter}.
A \defn{constant template parameter} is a template parameter introduced by a \grammarterm{parameter-declaration}.
A \defn{type template template parameter} is a template parameter introduced by a \grammarterm{type-tt-parameter}.
A \defn{variable template template parameter} is a template parameter introduced by a \grammarterm{variable-tt-parameter}.
A \defn{concept template parameter} is a template parameter introduced by a \grammarterm{concept-tt-parameter}.
...
\begin{itemize}
\item \placeholder{A} denotes a class template or alias template and \placeholder{P} is a \grammarterm{type-tt-parameter},
\item \placeholder{A} denotes a variable template and \placeholder{P} is a \grammarterm{variable-tt-parameter}, or
\item \placeholder{A} denotes a \grammarterm{qualified-concept-name} and \placeholder{P} is a \grammarterm{concept-tt-parameter}.
\end{itemize}
\end{addedblock}
