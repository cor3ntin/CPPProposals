...
its \added{type} template \grammarterm{template-argument}{s} and
...
A \defn{template template parameter} ia a \grammarterm{type-template-parameter}, a \grammarterm{variable-template-parameter},  or a \grammarterm{concept-parameter}. A \defn{constant template parameter} is a template parameter introduced by a \grammarterm{parameter-declaration}.
...
\begin{addedblock}
A template \grammarterm{template-argument} can name a type or alias template, a variable template, or a concept.
\end{addedblock}
...
\pnum
A \grammarterm{template-argument} for a \changed{\grammarterm{template-parameter} which is a type}{\grammarterm{type-parameter}} shall be a \grammarterm{type-id}.
