...
\begin{addedblock}
The associated constraints \tcode{C} of a declaration \tcode{D} are \emph{subsumption-elligible} unless \tcode{D} is a template-declaration and a subexpression of \tcode{C}
names a \grammarterm{concept-id} that designates a concept template parameter of D.
\end{addedblock}
