...
\item \tcode{tuple_of} \\
    ...
    a maintainance nightmare. We explore a tuple_of concept later in this paper.
...
Compare the \href{https://eel.is/c++draft/indirectcallable.indirectinvocable}{definitions in the standard} and \href{https://godbolt.org/z/ohKsoKh9G}{the implementatiion with our proposal}.
\end{itemize}
