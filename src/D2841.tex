...
The memory footisqprint is more difficult to gauge, but it seems around a 40\% difference.
...
\begin{tabular}{|l|l|}
    ...
    \hline
    \grammarterm{constant-parameter}&  constant template parameter \\
    \hline
    ...
    \hline
    \grammarterm{concept-template-parameter}& concept template template parameter\\
    \hline
\end{tabular}
...
A \defn{template template parameter} refers to either a \grammarterm{type-template-parameter}, a \grammarterm{variable-template-parameter},  or \grammarterm{concept-parameter}.
