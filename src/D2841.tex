...
\begin{tabular}{|l|l|}
    ...
    \hline
    \grammarterm{concept-parameter}& concept template parameter\\
    \hline
\end{tabular}
...
\begin{itemize}
    ...
    \item
    \grammarterm{parameter-declaration} \iref{dcl.fct} \added{, [temp.param]},
    \item
...
an alias template or \changed{a template \grammarterm{template-parameter}}{a type template template parameter}.
\begin{note}
...
% change font to non italizied.
% introduce a parameter or a pack
A \defn{template template parameter} is a \grammarterm{type-template-parameter}, a \grammarterm{variable-template-parameter},  or a \grammarterm{concept-parameter}.


A \defn{constant template parameter} is a template parameter introduced by a \grammarterm{parameter-declaration}.
...
% Introduce pack earlier where we introduce the grammar.
...
\begin{addedblock}
For a \grammarterm{type-template-parameter}, the name shall denote a class template or alias template. For a \grammarterm{variable-template-parameter}, the name shall denote a variable template. For a \grammarterm{concept-parameter}, the name shall denote a concept.
\end{addedblock}
...
\item \placeholder{A} denotes a \grammarterm{qualified-concept-name} and \placeholder{P} is a \grammarterm{concept-parameter}.
\end{itemize}
\end{addedblock}
