...
Yet, \paper{P2498R1}'s intent to rename \tcode{mib}` to \tcode{iana_mib} - a rename I'm not opposed to -
seems to directly contradict the concerns about relying on a IANA standard.

In any case, it behooves \paper{P2498R1} to determines whether the name "iana" can be used in the API from a legal standpoint.
