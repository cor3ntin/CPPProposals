...
\begin{itemdescr}
    ...
    \begin{itemize}
        ...
        \item \tcode{r.operator ::std::basic_string_view<charT, traits>()} is not a valid expression, and
        \item If the qualified-id \tcode{R::traits_type} is valid and denotes a type,\\ \tcode{is_same_v<remove_reference_t<R>::traits\_type, traits>} is \tcode{true}.
    \end{itemize}
    ...
    \throws
    Any exception thrown by \tcode{ranges::data(r)} and \tcode{ranges::size(r)} throw.
