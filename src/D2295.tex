...
\begin{addedblock}
    ...
    A \defn{UTF-8 file} is a source file encoded with the UTF-8 encoding scheme defined in ISO/IEC 10646.
    An implementation shall support \defn{UTF-8 file}{s}.
    If the source file is determined to be a \defn{UTF-8 file}, it shall represent a well-formed sequence of UTF-8 code units and the scalar value of each source character shall be preserved.    
