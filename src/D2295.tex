...
They also affect line-endings in raw string literals, which is the subject of \paper{CWG1655}.
...
A more through wording change would impact at least \tcode{[lex]}, \tcode{[cpp]}, \tcode{[time.format]}.

It is also unclear what the \tcode{new-line} character is, whether in escape sequences (\tcode{\textbackslash n}), raw line endings, etc.
