...
We intend that this paper addresses \paper{CWG1655}.
...
\begin{enumerate}
    ...
    \removed{Each comment is replaced by one space character}. \changed{New-line characters are}{Each \grammarterm{line-break} is}
...
\added{All} \cwhitespace{Whitespace} before the first preprocessing token and after the last
