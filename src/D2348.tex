...
\begin{enumerate}
    ...
    \changed{whitespace characters other than new-line}{\grammarterm{horizontal-whitespace-character}} followed by a \clb{new-line  character} is deleted, splicing
