...
\begin{itemize}
    \item Add explenation about not adapting this proposal to C arrays
...
As such we do not proposed the proposed syntax to apply to C arrays.
...
Again, we shouldn't change the meaning erxisting code in C++23.
We should only add multidimentional operators to new in C++23 types such as \tcode{mdspan}.
