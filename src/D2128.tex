...
Two examples of multidimensional arrays are the multidimensional array container \tcode{mdarray} (\href{wg21.link/p1684r0}{P1684R0})
and the multidimensional array view \tcode{mdspan} (\href{wg21.link/p0009r10}{P0009R10}).
...
\begin{itemize}
\item \tcode{mdspan} (\href{wg21.link/p0009r10}{P0009R10}) or \tcode{mdarray} (\href{wg21.link/p1684r0}{P1684R0});
