...
Opaque pointers, i.e classes that wraps a pointer in a type to block direct access to the pointer, or achieve some form of string typing
...
\begin{itemize}
\item The current design mandates the pointer-type to be default constructible. We could instaead make \tcode{pointer_tag_pair} conditionally
...
\begin{itemize}
\item Tombsone values in std::optional.
