...
% lah: Do you want to set constexpr in code font throughout? 
...
% lah: This subsection heading seems unnecessary.
...
% lah: Here, in the heading and in the text, you HAVE set constexpr in code font. 
...
So this solution is impractical. We could, as Richard Smith suggested, % lah: you need some kind of citation here? Where did he say this? A reader might want to follow this and learn more. 
make \tcode{constexpr} static only in some cases to alleviate some of the breakages or even make only constexpr bindings static, not other variables, but this option 
...
To quote the reflector: % lah: Did a specific person say this? If so, perhaps you should credit that person. 
...
\ednote{This wording makes constexpr structured only as a valid grammatical construct and does not permit automatic storage duration bindings of tuple-like objects.} % lah: Something isn't quite right in this sentence. I've changed it to what I think you intended, but reread it carefully. 
...
see~\ref{depr.volatile.type}. % lah: this cross-ref isn't functioning properly. 
