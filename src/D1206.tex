...
\begin{itemize}
    ...
    \item introduce \tcode{__cpp_lib_to} instead of bumping  \tcode{__cpp_lib_ranges}
\end{itemize}
...
Let \placeholder{container-inserter} be defined as follow:
    ...
    auto @\placeholder{container-inserter}@(C & c){
...
Add a new macro in \tcode{<version>} \tcode{__cpp_lib_to} set to the date of adoption.
The macro \tcode{__cpp_lib_to} is also present in <ranges>.
