...
We propose to lift restrictions on \grammarterm{universal-character-names} in identifiers.
...
\removed{If a \grammarterm{universal-character-name} outside
...
\begin{bnf}
    ...
    \added{universal-character-name\\
        \textnormal{    designating an element of the translation character set of class XID\_Continue}}
\end{bnf}
...
\begin{addedblock}
\grammarterm{universal-character-name}{s} are replaced by the designated element of the translation character set.
