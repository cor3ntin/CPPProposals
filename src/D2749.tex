...
\begin{enumerate}
    ...
    \begin{wfootnote}
        ...
        multi-\changed{character}{Unicode code point} token that requires a
        ...
        comment.
    \end{wfootnote}
    Each comment is replaced by one \changed{space character}{\unicode{0020}{SPACE}}. New-line characters are
    retained. Whether each nonempty sequence of whitespace characters other
    than new-line is retained or replaced by one \changed{space character}{\unicode{0020}{SPACE}} is
    unspecified.
...
\begin{note}
    A sequence of \changed{characters}{Unicode code points} resembling a \grammarterm{universal-character-name} in an
