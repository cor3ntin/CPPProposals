...
A \tcode{thread::id} object is formatted by writing its text representation \added{for \tcode{charT}} to the output with \grammarterm{thread-id-format-spec} applied.
\end{itemdescr}
