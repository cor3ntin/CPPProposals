...
Acheving the same result in C++20 requires duplicating the entire \tcode{std::thread}
...
to reimplement all of \tcode{sd::thread}.
...
While \tcode{sd::thread} has no mechanism to specify an execution context, an implementation that wishes
