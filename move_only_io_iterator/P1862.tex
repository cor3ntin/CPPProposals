...
\begin{codeblock}
	namespace std::ranges {
		...
		class subrange : public view_interface<subrange<I, S, K>> {
			...
			constexpr I begin() @\addedtwo{requires !forward_iterator<I>}@;
...
\begin{itemize}
	...
	\item Otherwise,
	\tcode{subrange\{counted_iterator\{\changed{E}{std::move(E)}, F\}, default_sentinel\}}.
\end{itemize}
...
\begin{itemdecl}
	constexpr iterator_t<base_t> base() @\added{\& requires copyable<iterator_t<V>>}@; const;
\end{itemdecl}
