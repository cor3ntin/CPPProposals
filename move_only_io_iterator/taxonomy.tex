...
% The first level, as children of the initial tree
  child {node[new] (c1) {ReadableIterator}
  	...
  	child {node[cpp17](Cpp17InputIterator) {Cpp17InputIterator}
  ...
  child {node[new] (c3) {WritableIterator}
    child {node[cpp17](Cpp17OutputIterator) {Cpp17OutputIterator}
    	child {node[cppclass] {ostream\_iterator}}
    	child {node[cppclass] {ostreambuf\_iterator}}
    }
