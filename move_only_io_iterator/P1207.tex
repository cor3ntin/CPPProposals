...
\begin{codeblock}
	...
	@\changed{Semiregular}{DefaultConstructible<I> \&\& Movable}@<I> &&
	requires(I i) {
...
\begin{itemdescr}
	...
	\tcode{current} with \changed{\tcode{i}}{\tcode{std::move(i)}}.
\end{itemdescr}
...
\begin{itemdescr}
	...
	\begin{addedblock}
		...
		\expects \tcode{Iterator} models \tcode{CopyConstructible}.
	\end{addedblock}
...
\begin{codeblock}
	namespace std {
		...
		class counted_iterator {
			...
			constexpr I base() const @\added{\& requires CopyConstructible<I>}@;
