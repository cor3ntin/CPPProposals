...
\begin{itemdescr}
    ...
    \begin{itemize}
        ...
        \item \tcode{is_same_v<ranges::range_value_t<R>, charT>} is true,
        \item \tcode{is_convertible_v<R, const charT*>} is \tcode{false},
        \item If the qualified-id \tcode{remove_reference_t<R>::traits_type} is valid and denotes a type, \tcode{is_same_v<remove_reference_t<R>::traits_type}, traits> is true.
    \end{itemize}
 
	\expects
	 \begin{itemize}
		\item \tcode{R} models \tcode{ranges::contiguous_range},
